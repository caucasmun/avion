        ...
        <section className={cn.second}>
            <div className="container">
                ...
                <div className={cn.row}>
                    ...
                    <div className={cn.item}>
                        <img src="/second/Sprout.png" alt="" className={cn.logo} />
