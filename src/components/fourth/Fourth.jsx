            ...
            <div className="container">
                ...
                <div className={cn.row}>
                    <div className={cn.item1}>
                        <img src={`${import.meta.env.BASE_URL}fourth/Item1.png`} alt="" className={cn.image1} />
                        <p className={cn.title}>The Poplar suede sofa</p>
                        <p className={cn.price}>£980</p>
                    </div>
                    <div className={cn.item}>
                        <img src={`${import.meta.env.BASE_URL}fourth/Item2.png`} alt="" className={cn.image} />
                        <p className={cn.title}>The Dandy chair</p>
                        <p className={cn.price}>£250</p>
                    </div>
                    <div className={cn.item}>
                        <img src={`${import.meta.env.BASE_URL}fourth/Item3.png`}alt="" className={cn.image} />
                        <p className={cn.title}>The Dandy chair</p>
                        <p className={cn.price}>£250</p>
                    </div>
                </div>
